...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "IDBI BANK Life Moments AI — Banking that understands you" },
      {
        name: "description",
        content:
          "AI-first banking from IDBI BANK that predicts your life events and guides you with transparent, customer-first recommendations.",
      },
      { name: "author", content: "IDBI Bank" },
      { property: "og:title", content: "IDBI BANK Life Moments AI" },
      {
        property: "og:description",
        content: "An intelligent financial companion that predicts your life events.",
      },
