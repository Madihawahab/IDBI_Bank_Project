...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SBI Life Moments AI — Banking that understands you" },
      {
        name: "description",
        content:
          "AI-first banking from SBI that predicts your life events and guides you with transparent, customer-first recommendations.",
      },
      { name: "author", content: "State Bank of India" },
